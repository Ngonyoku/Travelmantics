...
public class DealAdapter extends RecyclerView.Adapter<DealAdapter.DealViewHolder> {
    ...
    public DealAdapter() {
        ...
        mChildListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                TravelDeal td = dataSnapshot.getValue(TravelDeal.class); //It gets data from the db.
                Log.d("Deals", td.getTitle());
                td.setId(dataSnapshot.getKey()); //Id is set to the Push Id in the RealTime db.
                deals.add(td);
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v) {
            ...
            TravelDeal selectedDeal = deals.get(position); //Get the position of the Item on the List.
